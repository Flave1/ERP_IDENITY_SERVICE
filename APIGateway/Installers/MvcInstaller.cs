...
using APIGateway.Repository.Inplimentation.Setup;
using APIGateway.Repository.Inplimentation.Hrm_Employee;
...
namespace GODP.APIsContinuation.Installers
{
    public class MvcInstaller : IInstaller
    {
        ...
        public void InstallServices(IServiceCollection services, IConfiguration configuration)
        {
            ...
            services.AddScoped(typeof(ISetupRepository), typeof(SetupRepository));
