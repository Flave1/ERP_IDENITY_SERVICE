...
namespace APIGateway.Repository.Inplimentation.Workflow
{
    public class WorkflowRepository : IWorkflowRepository
    {
        ...
        public string Return_workflow_button_link(string link)
        {
            return  "<a href='link' style='background: #33A1FF; font-weight: bold; border:none; color: white; text-decoration: none; padding: 10px; border-radius: 10px;'>Click to see details</a>".Replace("link", link);
        }
        ...
        public async Task<bool> DeleteWorkflowAsync(int workflowId)
        {
            ...
            if (details.Any()) _dataContext.cor_workflowdetails.RemoveRange(details); 
