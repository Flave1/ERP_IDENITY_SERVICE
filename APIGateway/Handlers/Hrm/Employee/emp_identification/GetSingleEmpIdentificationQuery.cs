...
{
    public class GetSingleEmpIdentification_Query : IRequest<hrm_emp_identification_contract_resp>
    {
        public int EmpId { get; set; }
        public class GetSingleEmpIdentification_QueryHandler : IRequestHandler<GetSingleEmpIdentification_Query, hrm_emp_identification_contract_resp>
        {
            private readonly DataContext _data;
            private readonly IEmployeeRepository _employeeRepo;
            public GetSingleEmpIdentification_QueryHandler(
            ...
            public async Task<hrm_emp_identification_contract_resp> Handle(GetSingleEmpIdentification_Query request, CancellationToken cancellationToken)
            {
                ...
                var list = await _data.hrm_emp_identifications.Where(e => e.Id == request.EmpId && e.Deleted == false).ToListAsync();
