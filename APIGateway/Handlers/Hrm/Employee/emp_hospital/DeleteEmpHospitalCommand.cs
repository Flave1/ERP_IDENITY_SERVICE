...
{
    public class DeleteEmp_HospitalCommand : IRequest<DeleteRespObj>
    {
        public List<int> ItemIds { get; set; }
        public class DeleteEmp_HmoCommandHandler : IRequestHandler<DeleteEmp_HospitalCommand, DeleteRespObj>
        {
            ...
            public async Task<DeleteRespObj> Handle(DeleteEmp_HospitalCommand request, CancellationToken cancellationToken)
            {
                ...
                try
                {
                    if (request.ItemIds.Count() > 0)
                    {
                        ...
                        {
                            await _empRepo.DeleteEmpHospitalAsync(itemId);
                        }
                    }
