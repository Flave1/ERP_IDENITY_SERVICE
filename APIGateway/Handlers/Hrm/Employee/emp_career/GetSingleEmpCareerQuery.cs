...
{
    public class GetSingleEmpCareer_Query : IRequest<hrm_emp_career_contract_resp>
    {
        public int EmpId { get; set; }
        public class GetSingleEmpCareer_QueryHandler : IRequestHandler<GetSingleEmpCareer_Query, hrm_emp_career_contract_resp>
        {
            private readonly DataContext _data;
            private readonly ISetupRepository _setupRepo;
            private readonly ICommonRepository _commonRepository;

            public GetSingleEmpCareer_QueryHandler(
            ...
            public async Task<hrm_emp_career_contract_resp> Handle(GetSingleEmpCareer_Query request, CancellationToken cancellationToken)
            {
                ...
                var list = await _data.hrm_emp_career.Where(e => e.Id == request.EmpId && e.Deleted == false).ToListAsync();
