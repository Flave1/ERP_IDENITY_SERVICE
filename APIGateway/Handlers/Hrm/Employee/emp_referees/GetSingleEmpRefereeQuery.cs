...
{
    public class GetSingleEmpReferee_Query : IRequest<hrm_emp_referees_contract_resp>
    {
        public int EmpId { get; set; }
        public class GetSingleEmpReferee_QueryHandler : IRequestHandler<GetSingleEmpReferee_Query, hrm_emp_referees_contract_resp>
        {
            private readonly DataContext _data;
            private readonly IEmployeeRepository _employeeRepo;
            public GetSingleEmpReferee_QueryHandler(
            ...
            public async Task<hrm_emp_referees_contract_resp> Handle(GetSingleEmpReferee_Query request, CancellationToken cancellationToken)
            {
                ...
                var list = await _data.hrm_emp_referees.Where(e => e.Id == request.EmpId && e.Deleted == false).ToListAsync();
