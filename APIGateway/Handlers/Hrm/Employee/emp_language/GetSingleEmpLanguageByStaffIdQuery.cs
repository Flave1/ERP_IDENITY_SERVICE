...
{
    public class GetSingleEmpLanguageByStaffId_Query : IRequest<hrm_emp_language_contract_resp>
    {
        public int staffId { get; set; }
        public class GetSingleEmpLanguageByStaffId_QueryHandler : IRequestHandler<GetSingleEmpLanguageByStaffId_Query, hrm_emp_language_contract_resp>
        {
            private readonly DataContext _data;
            private readonly IEmployeeRepository _employeeRepo;
            private readonly ISetupRepository _setupRepo;

            public GetSingleEmpLanguageByStaffId_QueryHandler(
            ...
            public async Task<hrm_emp_language_contract_resp> Handle(GetSingleEmpLanguageByStaffId_Query request, CancellationToken cancellationToken)
            {
                ...
                var list = await _data.hrm_emp_language.Where(e => e.StaffId == request.staffId && e.Deleted == false).ToListAsync();
