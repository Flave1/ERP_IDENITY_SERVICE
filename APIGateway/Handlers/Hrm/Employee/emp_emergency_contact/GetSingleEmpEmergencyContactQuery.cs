...
{
    public class GetSingleEmpEmergencyContact_Query : IRequest<hrm_emp_emergency_contact_contract_resp>
    {
        public int EmpId { get; set; }
        public class GetSingleEmpEmergencyContact_QueryHandler : IRequestHandler<GetSingleEmpEmergencyContact_Query, hrm_emp_emergency_contact_contract_resp>
        {
            private readonly DataContext _data;
            private readonly IEmployeeRepository _employeeRepo;
            private readonly ICommonRepository _commonRepository;

            public GetSingleEmpEmergencyContact_QueryHandler(
            ...
            public async Task<hrm_emp_emergency_contact_contract_resp> Handle(GetSingleEmpEmergencyContact_Query request, CancellationToken cancellationToken)
            {
                ...
                var list = await _data.hrm_emp_emergency_contact.Where(e => e.Id == request.EmpId && e.Deleted == false).ToListAsync();
