    ...
    public static class DataSeederHandler
    {
                            ...
                            new cor_activityparent{ ActivityParentId = 6, ActivityParentName = "Credit", Deleted = false, Active = true, },
                             new cor_activityparent{ ActivityParentId = 7, ActivityParentName = "Investor Fund", Deleted = false, Active = true, },
                              new cor_activityparent{ ActivityParentId = 8, ActivityParentName = "Treasury", Deleted = false, Active = true, },
                               ...
                               new cor_activityparent{ ActivityParentId = 11, ActivityParentName = "HRM", Deleted = false, Active = true, },
        ...
        public static void SeedOperationType(DataContext context)
        {
            var operationtypes = new List<cor_operationtype>
            {
                    ...
                    new cor_operationtype { OperationTypeId = 7, ModuleId = 8, OperationTypeName = "Treasury", Deleted = false, Active = true },
                     ...
                     new cor_operationtype { OperationTypeId = 10, ModuleId = 11, OperationTypeName = "HRM", Deleted = false, Active = true }
            }; 
            using (var transaction = context.Database.BeginTransaction())
            {
                try
        ...
        public static void SeedActivities(DataContext context)
        {
            var operationtypes = new List<cor_activity>
            {
                 ...
                 new cor_activity{ ActivityId = 168, ActivityParentId = 11, ActivityName = "allemployees", Deleted = false, Active = true, },
                 new cor_activity{ ActivityId = 169, ActivityParentId = 11, ActivityName = "profile", Deleted = false, Active = true, },
                 new cor_activity{ ActivityId = 170, ActivityParentId = 11, ActivityName = "Location", Deleted = false, Active = true, },
                 new cor_activity{ ActivityId = 171, ActivityParentId = 11, ActivityName = "Job Title", Deleted = false, Active = true, },
                 new cor_activity{ ActivityId = 172, ActivityParentId = 11, ActivityName = "Job Grade", Deleted = false, Active = true, },
                 new cor_activity{ ActivityId = 173, ActivityParentId = 11, ActivityName = "Employment Type", Deleted = false, Active = true, },
                 new cor_activity{ ActivityId = 174, ActivityParentId = 11, ActivityName = "Academic Qualification", Deleted = false, Active = true, },
                 new cor_activity{ ActivityId = 175, ActivityParentId = 11, ActivityName = "Academic Discipline", Deleted = false, Active = true, },
                 new cor_activity{ ActivityId = 176, ActivityParentId = 11, ActivityName = "Academic Grade", Deleted = false, Active = true, },
                 new cor_activity{ ActivityId = 177, ActivityParentId = 11, ActivityName = "High School Subject", Deleted = false, Active = true, },
                 new cor_activity{ ActivityId = 178, ActivityParentId = 11, ActivityName = "High School Grades", Deleted = false, Active = true, },
                 new cor_activity{ ActivityId = 179, ActivityParentId = 11, ActivityName = "Professional Certification", Deleted = false, Active = true, },
                 new cor_activity{ ActivityId = 180, ActivityParentId = 11, ActivityName = "Languages", Deleted = false, Active = true, },
                 new cor_activity{ ActivityId = 181, ActivityParentId = 11, ActivityName = "Professional Membership", Deleted = false, Active = true, },
                 new cor_activity{ ActivityId = 182, ActivityParentId = 11, ActivityName = "HMO", Deleted = false, Active = true, },
                 new cor_activity{ ActivityId = 183, ActivityParentId = 11, ActivityName = "Employment Level", Deleted = false, Active = true, },
                 new cor_activity{ ActivityId = 184, ActivityParentId = 11, ActivityName = "Gym/Workout", Deleted = false, Active = true, },
                 new cor_activity{ ActivityId = 185, ActivityParentId = 11, ActivityName = "employeeform", Deleted = false, Active = true, },
                 new cor_activity{ ActivityId = 186, ActivityParentId = 11, ActivityName = "employeeidformat", Deleted = false, Active = true, },
                 new cor_activity{ ActivityId = 187, ActivityParentId = 11, ActivityName = "line manager", Deleted = false, Active = true, },
                 new cor_activity{ ActivityId = 188, ActivityParentId = 11, ActivityName = "Hospital Management", Deleted = false, Active = true, },
            };
            using (var transaction = context.Database.BeginTransaction())
            {
                try
            ...
            var opertaions = new List<cor_operation>
                {
                    ...
                    new cor_operation { OperationId =  42, OperationName = "PPERevaluation", OperationTypeId = 8, EnableWorkflow = true, Deleted = false, Active = true},
                     ...
                     new cor_operation { OperationId =  45, OperationName = "Profile Update", OperationTypeId = 10, EnableWorkflow = true, Deleted = false, Active = true},
