...
namespace APIGateway.Handlers.Common
{
    ...
    {
        public class GetAllCountriesQueryHandler : IRequestHandler<GetAllCountryQuery, CommonLookupRespObj>
        {
            private readonly ICommonRepository _repo;
            public GetAllCountriesQueryHandler(ICommonRepository commonRepository)
            {
